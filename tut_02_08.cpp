...
namespace
{
const char* const WINDOW_TITLE = "Victor Landi"; // Macro for window title
...
void UCreateMesh(GLMesh &mesh)
{
    ...
    GLfloat verts[]=
    {
        ...
        // Right triangle indices: 0, 1, 2
        // Left triangle indices: 0, 3, 4
        ...
        // index 1
        0.6f, 0.0f, 0.0f,     // right most portion of the screen
        1.0f, 0.0f, 0.0f, 1.0f, // red

        // index 2
        0.6f, -0.8f, 0.0f,      // bottom right of the screen
        0.0f, 1.0f, 0.0f, 1.0f, // green

        // index 3
       -0.6f, -0.0f, 0.0f,       // left side bottom of the screen
        0.0f, 0.0f, 1.0f, 1.0f, // blue

        // index 4
      -0.6f,0.8f, 0.0f,      // left side top of the screen
        1.0f, 0.0f, 0.0f, 1.0f  // red
    };
    ...
    GLushort indices[] = {0, 1, 2, 0, 3, 4}; // Using index 0 twice, center of screen
